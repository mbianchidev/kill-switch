...
enum Theme {
    ...
    static let diskCleanupAccent = Color(red: 0.43, green: 0.84, blue: 0.92)
    static let diskCleanupAction = Color(red: 0.95, green: 0.55, blue: 0.25)
    static let diskCleanupBar = Color(red: 0.67, green: 0.53, blue: 0.92)
